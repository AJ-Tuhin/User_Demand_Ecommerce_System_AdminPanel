...
namespace uCommerceMVC.Controllers
{
    public class ProductVerifiedController : Controller
    {
        ...
        {
            ViewBag.ProductId = new SelectList(db.vwNonVerifiedProducts, "Id", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,AdminUserId,DateTime,IP,ProductId")] ProductVerified productVerified)
        {
            ...
            ViewBag.ProductId = new SelectList(db.vwNonVerifiedProducts, "Id", "Name", productVerified.ProductId);
            return View(productVerified);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,AdminUserId,DateTime,IP,ProductId")] ProductVerified productVerified)
        {
            if (ModelState.IsValid)
            {
